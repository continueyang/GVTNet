...
def main():
    ...
    # HR images
    opt['input_folder'] = r'C:\Users\yang\Desktop\tst\ts'
    opt['save_folder'] = r'C:\Users\yang\Desktop\tst\ts16'
    opt['crop_size'] = 16
    opt['step'] = 16
    opt['thresh_size'] = 0
    ...
    # LRx2 images
    opt['input_folder'] = 'datasets/trainsets/DIV2K_train_LR_bicubic/X2'
    ...
    # LRx3 images
    opt['input_folder'] = 'datasets/trainsets/DIV2K_train_LR_bicubic/X3'
    ...
    # LRx4 images
    opt['input_folder'] = 'datasets/trainsets/DIV2K_train_LR_bicubic/X4'
